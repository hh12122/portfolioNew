<template>
  <footer class="bg-dark-primary dark:bg-black py-12">
      ...
      <div class="flex flex-col md:flex-row justify-between items-center">
        ...
        <div class="flex space-x-4">
          <a href="https://github.com/hh12122" target="_blank"
             class="w-10 h-10 bg-accent/10 rounded-full flex items-center justify-center hover:bg-accent hover:text-white transition-all">
